...
package com.ecashmeup.app.signinsignup.resetpassword
...
import com.ecashmeup.app.signinsignup.ConfirmPasswordState
...
fun ResetContent(
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Password(
            ...
            onImeAction = { onSignUpSubmitted(passwordState.text) },
