...
class EPaymentViewModel(private val userRepository: UserRepository) : ViewModel() {
...
class EPaymentViewModelFactory : ViewModelProvider.Factory {
    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ResetPasswordViewModel::class.java)) {
            return EPaymentViewModel(UserRepository) as T
        }
